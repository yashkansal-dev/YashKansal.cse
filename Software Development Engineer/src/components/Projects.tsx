  ...
  const projects = [
    {
      ...
      year: '2025',
      github: 'https://github.com/Kansal-ji/CodeSync',
    ...
    },
    {
      ...
      year: '2024',
      github: 'https://github.com/Kansal-ji/SmartSched',
    ...
    },
    {
      ...
      year: '2024',
      github: 'https://github.com/Kansal-ji/AidLink',
    ...
    },
    {
      ...
      year: '2023',
      github: 'https://github.com/Kansal-ji/SparkBook',
    ...
    <section id="projects" className="py-20 bg-gray-900">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {projects.map((project, index) => (
            ...
            >
              <div className="grid lg:grid-cols-2 gap-8">
                ...
                {/* RIGHT IMAGE */}
                {project.image && (
                  <div className="h-64 lg:h-auto overflow-hidden bg-gray-800">
                    <img
                      src={project.image}
                      alt={project.title}
                      className="
        ...
        <div className="mt-12 text-center">
          <a
            href="https://github.com/Kansal-ji"
            target="_blank"
            rel="noopener noreferrer"
            className="
