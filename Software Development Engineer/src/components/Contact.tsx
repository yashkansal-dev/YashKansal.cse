  ...
  const socialLinks = [
    {
      ...
      url: 'https://github.com/yashkansal-dev',
      icon: <Github size={24} />,
    ...
    },
    {
      ...
      url: 'https://www.linkedin.com/in/yashkansal-dev/',
    ...
    },
    {
      name: 'LeetCode',
      username: '@YashKansal-dev',
      url: 'https://leetcode.com/u/YashKansal-dev/',
      icon: <Code2 size={24} />,
    ...
    {
      name: 'X (Twitter)',
      username: '@yashkansal_dev',
      url: 'https://x.com/yashkansal_dev',
        ...
        <RevealOnScroll delay={0.6}>
          <div className="mt-12 text-center">
            ...
            <div className="flex flex-wrap justify-center gap-3">
              {['Software Engineering', 'Real-Time Systems', 'Cloud Architecture', 'AI/ML Models'].map(
                (interest, index) => (
                  <span
                    key={index}
